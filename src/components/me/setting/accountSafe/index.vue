...
export default {
  data () {
    return {
      accountSafe: [
        ...
        { name: "手机号", text: "18064034145", ico: ">" },
        { name: "微信密码", text: "已设置", ico: ">" },
        { name: "声音锁", text: "未设置", ico: ">" },
        { name: "应急联系人", text: "", ico: ">" },
        { name: "登录设备管理", text: "", ico: ">" },
        { name: "更多安全设置", text: "", ico: ">" },
        { name: "帮朋友冻结微信", text: "", ico: ">" },
        { name: "微信安全中心", text: "", ico: ">" }
      ],
      tips:
  ...
  methods: {
    ...
    init () {
      let initPageConfig = {
        header: this.settingAccountSafeHeader,
      }
